...
def parquetFactLifts():
    #setup logging
    logging = setupLogger('factlifts-parquet-to-S3')
    ...
    with engine.connect() as connection:
        try:
            ...
            selectQuery = 'select * from lift."FactLifts"'
            ...
            uploadParquetfile(df,'factlifts/', 'parquetFactLifts', 'lifting-parquet-files')
